 ...
 ***************************************************************************** */
  ...
  * <p>
  * <b>Getting started.</b>
  * To use this class, you must have {@code StdIn.class} in your Java classpath.
  * If you used our autoinstaller, you should be all set. Otherwise, either
  * download
  ...
  * strings.</b>
  * You can use the following methods to read numbers, strings, and booleans from
  ...
  * Windows, and Linux. The methods in {@code StdIn} are <em>blocking</em>, which
  * means that they will wait until you enter input on standard input. If your
  * program has a loop that repeats until standard input is empty, you must
  * signal that the input is finished. To do so, depending on your operating
  * system and IDE, use either {@code <Ctrl-d>} or {@code <Ctrl-z>}, on its own
  * line. If you are redirecting standard input from a file, you will not need to
  * do anything to signal that the input is finished.
  * <p>
  * <b>Known bugs.</b>
  * Java's UTF-8 encoding does not recognize the optional
  * <a href = "http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4508058">byte-order
 ...
 public final class StdIn {
      ...
      * @throws NoSuchElementException if standard input is empty
      * @throws InputMismatchException if the next token cannot be parsed as a
      * {@code boolean}: {@code true} or {@code 1} for true, and {@code false} or
